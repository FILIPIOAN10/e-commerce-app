 ...
 * @param expectedTotal       the order total the server computed; each gateway
 *                             converts this to its own unit as needed
 */
public record PaymentAttempt(String paymentMethod, String gatewayName,
                             String gatewayPaymentId, double expectedTotal) {

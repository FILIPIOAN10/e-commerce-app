...
const Checkout = () => {
  ...
  return (
    <div className='py-14 min-h-[calc(100vh-100px)]'>
      ...
      <div
        className='flex justify-between items-center px-4 fixed z-50 h-24 bottom-0 bg-white dark:bg-gray-800 left-0 w-full py-4 border-slate-200 dark:border-gray-700'

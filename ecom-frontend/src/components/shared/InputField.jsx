const InputField = ({
    ...
    return  (
        <div className="flex flex-col gap-1 w-full">
            ...
            className={`${
                className ? className : ""
            } px-2 py-2 border outline-none ${readOnly ? "bg-slate-100":"bg-transparent"} text-slate-800 dark:text-white dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 rounded-md ${
